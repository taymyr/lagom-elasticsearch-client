...
import org.taymyr.lagom.elasticsearch.client.dsl.SearchResult
import org.taymyr.lagom.elasticsearch.client.dsl.UpdateIndexItem
...
abstract class AbstractElasticRepository<IT: Indexable, QRT: SearchResult<IT>>(
        private val elasticSearch: ElasticSearchKt
) {
